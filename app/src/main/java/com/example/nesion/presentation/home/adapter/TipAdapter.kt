...
class TipAdapter: RecyclerView.Adapter<TipAdapter.MyViewHolder>(){
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.binding.apply {
            ...
            holder.itemView.setOnClickListener{
                ...
                intent.putExtra(DetailActivity.NEWS_DATA, listTip[position])
                it.context.startActivity(intent)
            }
        }
    }

    override fun getItemCount() = listTip.size

    fun setTip(data : List<LazyResponse>){
        listTip.clear()
        listTip.addAll(data)
